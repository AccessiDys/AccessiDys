...
exports.create = function(req, res) {
    ...
    var documentFils1 = new Document({titre: 'fils 1' ,image: document.image, children: []});
    var documentFils2 = new Document({titre: 'fils 2' ,image: document.image, children: []});
    var documentFils3 = new Document({titre: 'fils 3' ,image: document.image, children: []});
    var documentFils4 = new Document({titre: 'fils 4' ,image: document.image, children: []});
    var documentFils5 = new Document({titre: 'fils 5' ,image: document.image, children: []});
