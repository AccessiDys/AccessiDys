...
describe('Controller:ApercuCtrl', function() {
  ...
  var document = {"titre": "","text": "","image": "","_id": "52cb58487b0e99880d000004","__v": 0,"children": [{"titre": "fils 1","text": "","source": "files/decoup.thumb_0.9390108054503798.png","children": [],"image": "","_id": "52cb58487b0e99880d000005"}, {"titre": "fils 2","text": "","source": "files/decoup.thumb_0.6781442742794752.png","children": [],"image": "","_id": "52cb58487b0e99880d000006"}]};
  ...
  beforeEach(inject(function($controller, $rootScope, $httpBackend) {
	...
	$httpBackend.whenPOST('/chercherTagsParProfil', { idProfil: $rootScope.profil_id }).respond(angular.toJson(profilTags));
    
    // Mocker le service de selection des documents
    $httpBackend.whenPOST('/getDocument', { idDoc: $rootScope.idDocument[0] }).respond(angular.toJson(document));
