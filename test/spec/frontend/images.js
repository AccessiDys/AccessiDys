...
describe('Controller:ImagesCtrl', function() {
  ...
  beforeEach(inject(function($controller, $rootScope, $httpBackend, configuration) {
    ...
    scope.apercuName = 'K-L-1234567.html';
    scope.manifestName = 'K-L-1234567.manifest';
    scope.currentImage = {
      source: './files/image.png',
    ...
    $httpBackend.whenPUT('https://api-content.dropbox.com/1/files_put/sandbox/' + scope.manifestName + '?access_token=' + profile.dropbox.accessToken).respond('');
