...
describe('Controller:AdminPanelCtrl', function () {
    ...
    it('AdminPanelCtrl:	updateOcrAutorisation', inject(function () {
        ...
        var tmp = accounts[0];
        tmp.local.authorisations.ocr = !tmp.local.authorisations.ocr;
        $scope.updateOcrAutorisation(tmp);
    }));
    ...
    it('AdminPanelCtrl:	updateAudioAutorisation', inject(function () {
        ...
        var tmp = accounts[0];
        tmp.local.authorisations.audio = !tmp.local.authorisations.audio;
        $scope.updateAudioAutorisation(tmp);
    }));
