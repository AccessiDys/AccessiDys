...
<%- URL_REQUEST %>/bower_components/sass-bootstrap/js/carousel.js
<%- URL_REQUEST %>/bower_components/sass-bootstrap/js/transition.js
<%- URL_REQUEST %>/bower_components/sass-bootstrap/js/collapse.js
<%- URL_REQUEST %>/bower_components/sass-bootstrap/js/dropdown.js
<%- URL_REQUEST %>/bower_components/sass-bootstrap/js/modal.js
<%- URL_REQUEST %>/bower_components/sass-bootstrap/js/scrollspy.js
...
<%- URL_REQUEST %>/styles/images/apercu_sidebar/page_apercu.png
<%- URL_REQUEST %>/styles/images/apercu_sidebar/lecture_apercu.png
...
<%- URL_REQUEST %>/styles/images/gplus_share.jpg
<%- URL_REQUEST %>/styles/images/twitter_share.jpg
