...
<body key-trap class="body-home" data-ng-app="cnedApp" history-browser="">
    ...
    <script src="<%- URL_REQUEST %>/scripts/controllers/common/informationModal.js"></script>
    ...
    <script src="<%- URL_REQUEST %>/scripts/controllers/workspace/listDocumentModal.js"></script>
