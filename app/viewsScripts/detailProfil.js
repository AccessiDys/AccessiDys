                    ...
                    '<div class="regles_exists editing_tag">'+
                      '<ul>'+
                        '<li data-ng-repeat="var in tagStyles">'+
                          ...
                          '<a class="set_tag" href="" title="Editer le Style" data-ng-click="dupliqueModifierTag(var)">&nbsp;</a>'+
                          '<a class="delete_tag" href="" title="Supprimer le Style" data-ng-click="editionSupprimerTag(var)">&nbsp;</a>'+
                        '</li>'+
                      '</ul>'+
                    '</div>'+
                  '</div>'+
