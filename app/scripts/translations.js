...
angular.module('gettext').run([ 'gettextCatalog', function(gettextCatalog) {
    gettextCatalog.setStrings('en_US', {
        ...
        'Type' : 'Type',
        'Coloration' : 'Colors',
        'Type de coloration' : 'Type of coloration',
        'Groupe de souffle': 'Breath Group',
        'Cliquer pour modifier la couleur': 'Click to modify the color',
        'Valider' : 'Submit',
    ...
    gettextCatalog.setStrings('fr_FR', {
        ...
        'Regles' : 'Règles',
        'Coloration' : 'Couleurs',
        'Type de coloration' : 'Type de coloration',
        'Groupe de souffle': 'Groupe de souffle',
        'Cliquer pour modifier la couleur': 'Cliquer pour modifier la couleur',
        'Accueil' : 'Accueil',
        'Action' : 'Action',
        'Ajouter' : 'Ajouter',
        ...
        'document.message.copy.confirm.title': 'Duplication de votre document.',
        'document.message.copy.confirm.message': 'Êtes-vous sûr de vouloir vous dupliquer ce document ? ',
        ...
        'folder.message.info.rename.inprogress': 'Renommage de votre dossier en cours. Veuillez patienter.',
        'document.message.info.delete.inprogress': 'Supression du document en cours. Veuillez patienter.',
        'folder.message.info.delete.inprogress': 'Supression du dossier en cours. Veuillez patienter.',
        ...
        'folder.label.delete.anwser': 'Voulez-vous supprimer le dossier " <b>document.name</b> " ?',
        'folder.label.delete.title': 'Supprimer le dossier',
        'document.message.info.move.inprogress': 'Déplacement en cours...',
        'document.message.move.confirm.title': 'Déplacement de votre fichier',
        'folder.message.move.confirm.title': 'Déplacement de votre dossier',
        'document.message.move.confirm.message': 'Êtes-vous sûr de vouloir déplacer "%%FROM%%" vers "%%TO%%" ?',
        'documents.message.move.ok': 'Votre fichier a bien été déplacé.',
        'folder.message.create.ok': 'Le dossier a bien été créé.',
        'folder.message.create.ko.alreadyexist': 'Le dossier existe déjà',
