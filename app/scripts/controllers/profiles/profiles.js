...
angular.module('cnedApp').controller('ProfilesCtrl', function($scope, $http, $rootScope) {
	...
	/* Initialisations */
	$scope.displayText = 'Kamel & Leon est une application qui permet d\'adapter l\'ergonomie des supports scolaires afin d\'aider les familles, les enseignants et les élèves. ';
	$scope.flag = false;
