...
angular.module('cnedApp').controller('AddDocumentCtrl', function($scope, $rootScope, $routeParams, $timeout, tagsService, serviceCheck, $http, $location, dropbox, $window, configuration, htmlEpubTool, md5, fileStorageService, removeStringsUppercaseSpaces) {
