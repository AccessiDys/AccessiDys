...
cnedApp.service('speechService', function ($window) {
	...
	/**
	  * Découpe le texte si s'il contient un ':', ';'.
	  * Appelle les autres fonctions de découpe si ce n'est pas suffisant.
	...
	/**
	  * Découpe le texte si s'il contient un ' '
	  * Découpe le texte en bloc de 200 caractères si ce n'est pas suffisant.
	...
	/**
	  * Lit le texte donné après découpe et avec la voix accessible selon le mode (connecté/déconnecté)
	  * @method splitTextPriority5
	  */
