					...
					'<div>'+
						'<div class="box">'+
							...
							'</div>'+
								...
								'</p>'+
									'<div class="more">'+
									'<a href="/auth/dropbox" class="btn_simple light_blue pull-right" title="Suivant">Suivant</a>'+
								'</div>'+
							'</div>'+
								...
								'<p>Votre compte sur l’application CnedAdapt est maintenant associé à votre compte DropBox</p>'+
									...
									'<button ng-show=\'toStep3Button\' ng-click=\'toStep3()\' class="btn_simple light_blue pull-right animated fadeInRight" title="Suivant">Suivant</button>'+
								'</div>'+
							'</div>'+
						'</div>'+
					'</div>'+
			...
			'</div>'+
				'<div ng-show=\'inscriptionStep4\' class=\'animated fadeInRight\' style=\'margin-top: 20px\'>'+
					'<div>'+
						...
						'</p>'+
							'<div class="more">'+
							'<a href=\'{{profileDropbox}}\' class="btn_simple light_blue pull-right" title="Suivant">Suivant</a>'+
						'</div>'+
					'</div>'+
				'</div>'+
			'</div>'+
...
'</div>'+
	'<div class="modal fade in" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">'+
		'<div class="modal-dialog bigger">'+
			...
			'</div>'+
				'<div class="centering">'+
				'<button type="button" class="btn_simple light_blue" data-dismiss="modal" title="OK">OK</button>'+
			'</div>'+
		'</div>'+
	'</div>'+
'</div>'+
