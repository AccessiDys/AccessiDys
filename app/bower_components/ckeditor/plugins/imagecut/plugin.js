...
(function() {
  ...
  CroppingManager.prototype.onMouseDown = function(event) {
    ...
    if (this.buttonIsOn() && event.data.getTarget().getName() === 'img') {
      ...
      this.rectangle.x = this.rectangle.origin.x = event.data.$.clientX - boundingBox.left;
      this.rectangle.y = this.rectangle.origin.y = event.data.$.clientY - boundingBox.top;
